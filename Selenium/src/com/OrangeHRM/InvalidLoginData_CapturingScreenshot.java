...
public class InvalidLoginData_CapturingScreenshot {
	...
	public static void main(String[] args) throws IOException {
		...
		else
		{
			...
			FileUtils.copyFile(OrangeHRm_Login_Screenshot,new File("E:\\GPK_WorkSpace\\Selenium\\OrangeHRM_ScreenshotsCaptured\\Orange_login.png"));
